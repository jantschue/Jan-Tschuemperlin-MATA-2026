...
files = [
    os.path.join(base_dir, "data", "external", "weather", "Luzern", "wetter_luzern_2010-2026_filtered.csv"),
    os.path.join(base_dir, "data", "external", "weather", "Waedenswil", "wetter_waedenswil_2010-2026_filtered.csv"),
]
