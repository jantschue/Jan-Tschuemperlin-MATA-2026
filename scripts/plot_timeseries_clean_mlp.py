...
zusammenhaengenden Wochen des Testsets fuer die Station Schwyz R1 (MLP-
Hauptmodell v8). Es liest die bereits erzeugten Vorhersagen aus
results/model_results/mlp_v8/predictions/ und stellt den gemessenen Verkehr
(schwarz) der Vorhersage (orange) gegenueber.
...
Ergebnis:
    results/model_results/mlp_v8/summary/timeseries_clean_Schwyz_R1.png
"""
...
# ── Konfiguration ────────────────────────────────────────────────────────────
PRED_CSV = Path("results/model_results/mlp_v8/predictions/predictions_720_Schwyz_R1_v8.csv")
OUT_PATH = Path("results/model_results/mlp_v8/summary/timeseries_clean_Schwyz_R1.png")
