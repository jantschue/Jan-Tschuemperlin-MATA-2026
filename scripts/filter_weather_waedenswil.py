...
def main():
    ...
    input_file = os.path.join(base_dir, "data", "weather", "raw", "Waedenswil", "weather_waedenswil_2010-2026.csv")
    output_dir = os.path.join(base_dir, "data", "weather", "processed")
    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(output_dir, "weather_waedenswil_2010-2026_filtered.csv")
