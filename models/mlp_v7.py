...
auf den v7-Daten. v7 entspricht den Corona-bereinigten v6-Daten, ersetzt aber die
binäre is_holiday-Spalte durch 26 kantonsspezifische Feiertagsspalten
(holiday_AG … holiday_ZH). Hyperparameter bleiben identisch zum v5/v6-Modell, damit
der Unterschied wirklich nur aus der feineren Feiertagskodierung kommt.
"""
