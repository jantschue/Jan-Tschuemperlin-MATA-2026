...
auf den v7-Daten als Baseline zum v7-MLP. v7 ersetzt die binaere is_holiday-Spalte
durch 26 kantonsspezifische Feiertagsspalten (holiday_AG … holiday_ZH). Die
Resultate werden in einem separaten Verzeichnis abgelegt, damit die bestehenden
v5- und v6-Resultate unveraendert bleiben.
"""
...
RESULTS_DIR = Path("results/model_results/linear_regression_v7")

DATASETS = [
    "050_Brunnen_Mositunnel_R1_v7.csv", "050_Brunnen_Mositunnel_R2_v7.csv",
    "171_Sattel_R1_v7.csv", "171_Sattel_R2_v7.csv",
    "216_Wangen_SZ_R1_v7.csv", "216_Wangen_SZ_R2_v7.csv",
    "299_Wollerau_Blatttunnel_R1_v7.csv", "299_Wollerau_Blatttunnel_R2_v7.csv",
    "720_Schwyz_R1_v7.csv", "720_Schwyz_R2_v7.csv"
]

# v7-Feature-Satz: 26 kantonsspezifische Feiertagsspalten statt binaerem is_holiday
FEATURES = [
...
# ── Stationsspezifische Feature-Ausnahmen (identisch zu mlp_v7.py) ────────────
...
# und entgleist die Vorhersage. Damit die LR-Baseline konsistent zum v7-MLP ist,
